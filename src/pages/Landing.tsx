...
function Landing() {
  ...
  }, [setLocation]);  // Include setLocation in the dependency array
  ...
  async function handleCity(e: FormEvent) {
    ...
    await api.get(`?q=${city}&appid=e81965343df414cbfb25d98c8741fe2a&lang=us_en&units=metric`).then(response => {
  ...
  async function handleCityByCordinates(lat: number, lon: number) {
    await api.get(`?lat=${lat}&lon=${lon}&appid=e81965343df414cbfb25d98c8741fe2a&lang=us_en&units=metric`).then(response => {
      setValid(true)
      setData(response.data)
    })
  }
    ...
    <div id="main" >
      ...
      <div className="main-grid">
        <div className="app-name">
          <p className='header'>Weather <span> App</span></p>
        </div>
        ...
        <div className="credits">
          by&nbsp;
          <a href="https://github.com/AhmadHusirami" target="_blank" rel="noopener noreferrer">
            <strong>Ahmad Said Husirami</strong>
          </a>
        </div>
      </div>
